...
#[cfg(any(target_os = "openbsd", target_os = "freebsd", target_os = "dragonfly", target_os = "bitrig", target_os = "macos"))]
const IP_TOS: c_int = 3;

#[cfg(not(any(target_os = "linux", target_os = "openbsd", target_os = "freebsd", target_os = "dragonfly", target_os = "bitrig", target_os = "macos")))]
#[allow(unused_variables)]
pub fn set_dscp_for_priority(fd: RawFd, prio: Priority) -> Result<(), Error> {
    Ok(())
}

#[cfg(any(target_os = "linux", target_os = "openbsd", target_os = "freebsd", target_os = "dragonfly", target_os = "bitrig", target_os = "macos"))]
pub fn set_dscp_for_priority(fd: RawFd, prio: Priority) -> Result<(), Error> {
